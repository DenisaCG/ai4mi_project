...
Each row is one patient's scan, each column an HU band. Circle size and colour
...
MIN_PCT = 1e-3  # log colour/size floor, in percent of a scan's voxels
MAX_PCT = 60  # log colour/size ceiling, in percent of a scan's voxels
...
def main():
    ...
    cb.set_label("% of the scan's voxels (size and colour)")
